    ...
    <tr>
      <td width="650" height="99" bgcolor="#FFFFFF">
        <a href="http://www.pfca34.org" target="_blank" style="display: block;">
          <img border="0" src="<?php echo $base_path; ?>/sites/all/themes/pfca/images/newsletter/header.gif" width="650" height="99" alt="PFCA34 - La Newsletter" style="display: block;"/>
        </a>
      </td>
    </tr>
  </table>
  <table width="650" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td width="650" height="20" colspan="3" bgcolor="#e56630">
        <a href="http://www.pfca34.org" target="_blank"><img border="0" src="<?php echo $base_path; ?>/sites/all/themes/pfca/images/newsletter/bandeau_top_2.gif" width="650" height="20" style="display: block;"/></a>
      </td>
    </tr>
    <tr>
      ...
      <td width="318" height="33" bgcolor="#e56630">
        <a href="http://www.pfca34.org" target="_blank"><img border="0" src="<?php echo $base_path; ?>/sites/all/themes/pfca/images/newsletter/bandeau_right_2.gif" width="318" height="33" style="display: block;"/></a>
      </td>
    </tr>
    <tr>
      <td width="650" height="36" colspan="3" bgcolor="#e56630">
        <a href="http://www.pfca34.org" target="_blank"><img border="0" src="<?php echo $base_path; ?>/sites/all/themes/pfca/images/newsletter/bandeau_bot_2.gif" width="650" height="36" style="display: block;"/></a>
      </td>
    </tr>
  </table>
  <!-- Fin Header -->
			...
			<td width="400" valign="top">
					...
					<table width="400" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#4b4b4b">
						<tr>
						  <td width="46" height="40" bgcolor="#4b4b4b">
							<img border="0" src="<?php echo $base_path; ?>/sites/all/themes/pfca/images/newsletter/picto_agenda_2.gif" width="46" height="40"/>
						  </td>
						...
						<table width="400" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="260" valign="top">
									<!-- Titre -->
									<span><a style="font-weight : bold; font-size : 13px; color : #4B4B4B; text-decoration : none;" href="<?php echo url( 'node/' . $agenda_data->nid ); ?>" title="<?php echo $agenda_data->title; ?>" target="_blank"><?php echo $agenda_data->title; ?></a></span>
									<!-- Separator -->
					...
					<table width="400" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="360" align="right">
								<a href="http://www.pfca34.org/agenda" target="_blank" title="Tout l'agenda"><img src="<?php echo $base_path; ?>/sites/all/themes/pfca/images/newsletter/tout_agenda_btn.gif" alt="Tout l'agenda" /></a>
							</td>
							<td height="20" width="20"></td>
						</tr>
					</table>
				...
				<?php if( !empty( $node->field_actualites_liees['und'] ) ) { ?>
					<table width="400" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#4b4b4b">
						<tr>
						  <td width="46" height="40" bgcolor="#4b4b4b">
							<img border="0" src="<?php echo $base_path; ?>/sites/all/themes/pfca/images/newsletter/picto_rubrique_2.gif" width="46" height="40"/>
						  </td>
						  <td width="354" height="40" bgcolor="#4b4b4b" style="font-family: Arial, sans-serif;font-size: 16px;font-weight: bold;color: #FFFFFF;text-transform: uppercase;">
				...
				?>
					<table width="400" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="20" width="20"></td>
							<td width="360" align="right">
								<a href="http://www.pfca34.org/actualites" target="_blank" title="voir toutes les actualit&eacute;s"><img src="<?php echo $base_path; ?>/sites/all/themes/pfca/images/newsletter/toutes_actus_btn.gif" alt="Toutes les actualit&eacute;s" /></a>
							</td>
							<td height="20" width="20"></td>
						</tr>
					</table>
    ...
    <tr>
      <td width="420" height="131">
        <a href="http://www.pfca34.org" title="Visitez notre site" target="_blank" style="display: block;">
          <img border="0" width="420" height="131" src="<?php echo $base_path; ?>/sites/all/themes/pfca/images/newsletter/footer_txt.gif" style="display: block;"/>
        </a>
      </td>
	  <td width="230" height="131">
        <a href="http://www.pfca34.org/content/contact" title="Contactez-nous" target="_blank" style="display: block;">
          <img border="0" width="230" height="131" src="<?php echo $base_path; ?>/sites/all/themes/pfca/images/newsletter/footer_contact.gif" style="display: block;"/>
        </a>
      </td>
    </tr>
  </table>
    ...
    <tr>
      <td width="650" height="37">
        <a href="http://www.choosit.com" title="Choosit l'agence digitale" target="_blank" style="display: block;">
          <img border="0" width="650" height="37" src="<?php echo $base_path; ?>/sites/all/themes/pfca/images/newsletter/choosit_2.gif" style="display: block;"/>
        </a>
      </td>
    </tr>
  </table>
