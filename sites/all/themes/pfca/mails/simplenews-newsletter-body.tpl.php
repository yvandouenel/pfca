...
<table cellpadding="0" cellspacing="0" border="0" width="650" align="center"> <!-- table general -->
    ...
    <tr>
      <td width="650" height="99" bgcolor="#FFFFFF">
        <a href="http://www.pfca34.org" target="_blank" style="display: block;">
          <img border="0" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/header.gif" width="650" height="99" alt="PFCA34 - La Newsletter" style="display: block;"/>
        </a>
      </td>
    </tr>
  </table>
  <table width="650" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td width="650" height="20" colspan="3" bgcolor="#e56630">
        <img border="0" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/bandeau_top.gif" width="650" height="20" style="display: block;"/>
      </td>
    </tr>
    <tr>
      ...
      <td width="318" height="45" bgcolor="#e56630">
        <img border="0" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/bandeau_right.gif" width="318" height="45" style="display: block;"/>
      </td>
    </tr>
    <tr>
      <td width="650" height="89" colspan="3" bgcolor="#e56630">
        <img border="0" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/bandeau_bot.gif" width="650" height="89" style="display: block;"/>
      </td>
    </tr>
  </table>
  <!-- Fin Header -->
  ...
  <table width="650" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#4b4b4b">
    <tr>
      <td width="46" height="59" bgcolor="#4b4b4b">
        <img border="0" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/picto_rubrique.gif" width="46" height="59"/>
      </td>
  ...
  <table width="650" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td width="630" height="1" colspan="4"><img border="0" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/line_divider.gif" width="80" height="1"/></td>
    </tr>
    <tr>
      <td width="20" height="20"></td>
      <td width="630" height="20" colspan="4"></td>
        ...
        <table width="360" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
          ...
          <tr>
            <td width="360" bgcolor="#e76807" style="text-align: center;">
              <a target="_blank" href="<?php echo url($node->field_lien_flash_info['und'][0]['url'], array('absolute' => TRUE)); ?>" title="" style="display: block;padding-top: 10px;padding-bottom: 10px;font-size: 13px;font-weight: bold;color: #FFFFFF;text-transform: uppercase;text-decoration: none;text-align: center;">
              ...
              <table width="250" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#eeeeee">
                <tr>
                  <td width="250" height="50" colspan="3">
                    <img border="0" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/titre_lien_utiles.gif" width="250" height="50"/>
                  </td>
                </tr>
                <tr>
                  <td width="20"></td>
                  ...
                  <?php foreach($node->field_liens_utiles_flash_info['und'] as $liens_utiles){ ?>
                    <a target="_blank" href="<?php echo url($liens_utiles['url'], array('absolute' => TRUE)); ?>" style="color: #4b4b4b;"><?php echo $liens_utiles['title']; ?></a><br/>
                   <?php } ?>
                  </td>
                  <td width="20"></td>
                </tr>
          ...
          <tr>
            <td width="250">
              <table width="250" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#879e33">
                <tr>
                  <td width="250" height="50" colspan="3">
                    <img border="0" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/titre_telechargement.gif" width="250" height="50"/>
                  </td>
                </tr>
                <tr>
                  ...
                  ?>
                    <a href="<?php echo url(download_file_url($dl_flash_info['fid']), array('absolute' => TRUE)); ?>" style="color: #FFFFFF;"><?php if($dl_flash_info['description'] != ""){ echo $dl_flash_info['description']."<br/>"; }  ?></a>
                    <?php } ?>
                  </td>
                  <td width="20"></td>
                </tr>
    ...
    <tr>
      ...
      <td width="630" colspan="4">
        ...
        <table width="630" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
          <tr>
            <?php foreach($node->field_visuels_flash_info['und'] as $visuels_flash_info){
            ...
            <td style="text-align: left;vertical-align: middle;">
				<?php if($image_flash_info->field_lien_fc_flash_info['und'][0]['value']): ?><a href="<?php echo url($image_flash_info->field_lien_fc_flash_info['und'][0]['value'], array('absolute' => TRUE)); ?>" style="display: block;"><?php endif; ?>
					<?php print $thumb; ?>
...
<?php
  ...
  <table width="650" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
    ...
    <tr>
      <td width="20"></td>
      <td width="630" colspan="4" style="font-family: Arial, sans-serif;font-size: 16px;font-weight: bold;color: #4b4b4b;text-transform: uppercase;"><a href="<?php echo url(drupal_get_path_alias('node/'.$mynode_ac->nid), array('absolute' => TRUE)); ?>" title="" style="display: block; font-family: Arial, sans-serif;font-size: 16px;font-weight: bold;color: #4b4b4b;text-transform: uppercase; text-decoration:none;"><?php echo $mynode_ac->title;  ?></a></td>
    </tr>
    <tr>
      <td width="20" height="15"></td>
      <td width="630" height="15" colspan="4"></td>
    ...
    <tr>
      ...
      <td width="360" style="vertical-align: top;">
        <table width="360" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
          ...
          <tr>
            <td width="360">
             <?php echo $mynode_ac->body['und'][0]['summary'];  ?>
            </td>
          </tr>
          <!-- Fin Contenu/Résumé -->
          <tr>
          ...
          <tr>
            <td width="360" height="32">
              <a href="<?php echo url(drupal_get_path_alias('node/'.$mynode_ac->nid), array('absolute' => TRUE)); ?>" title="Lire la suite sur notre site" style="display: block;">
                <img border="0" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/btn_plus.gif" width="32" height="32" alt="Bouton lire la suite sur notre site" title="Lire la suite sur notre site" style="display: block;"/>
              </a>
            </td>
          </tr>
          <!-- Fin Bouton + -->
              ...
              <table width="250" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#eeeeee">
                ...
                <tr>
                  ...
                  <?php foreach($actualites->field_liens_utiles_actualites['und'] as $liens_utiles_ac){ ?>
                    <a target="_blank" href="<?php echo url($liens_utiles_ac['url'], array('absolute' => TRUE)); ?>" style="color: #4b4b4b;"><?php echo $liens_utiles_ac['title']; ?></a><br/>
                   <?php } ?>
                  </td>
                  <td width="20"></td>
                </tr>
            ...
            <td width="250">
              <table width="250" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#879e33">
                ...
                <tr>
                  ...
                  ?>
                    <a href="<?php echo url(download_file_url($dl_actus['fid']), array('absolute' => TRUE)); ?>" style="color: #FFFFFF;"><?php if($dl_actus['description'] != "" ){ echo $dl_actus['description']."<br/>"; } ?></a>
                    <?php }  ?>
                  <?php
                  foreach($actualites->field_telechargements_actualites['und'] as $dl_actu){
                  ?>
                    <a href="<?php echo url(download_file_url($dl_actu['fid']), array('absolute' => TRUE)); ?>" style="color: #FFFFFF;"><?php if($dl_actu['description'] != ""){ echo $dl_actu['description']."<br/>"; } ?></a>
                    <?php }  ?>
                  </td>
                  <td width="20"></td>
                </tr>
    ...
    <tr>
      ...
      <td width="630" colspan="4">
        ...
        <table width="630" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
          <tr>
            <?php foreach($actualites->field_visuels_actualites['und'] as $visuels_actualites){
            ...
            ?>
            <td style="text-align: left;vertical-align: middle;">
				<?php if($image_actualites->field_lien_fc_actualite['und'][0]['url']): ?><a href="<?php echo url($image_actualites->field_lien_fc_actualite['und'][0]['url'], array('absolute' => TRUE)); ?>" style="display: block;"><?php endif; ?>
					<?php print $thumb; ?>
...
<?php } ?>
  ...
  <table width="650" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
    ...
    <tr>
      <td width="20"></td>
      <td width="630" colspan="4" style="font-family: Arial, sans-serif;font-size: 16px;font-weight: bold;color: #4b4b4b;text-transform: uppercase;"><a href="<?php echo url(drupal_get_path_alias('node/'.$mynode->nid), array('absolute' => TRUE)); ?>" title="" style="display: block; font-family: Arial, sans-serif;font-size: 16px;font-weight: bold;color: #4b4b4b;text-transform: uppercase; text-decoration:none;"><?php echo $mynode->title;  ?></a></td>
    </tr>
    <tr>
      <td width="20" height="15"></td>
      <td width="630" height="15" colspan="4"></td>
      ...
      <td width="360" style="vertical-align: top;">
        <table width="360" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
         <?php if(isset($mynode->field_agenda_thematique['und'])){ ?>
          ...
          <tr>
            <td width="360">
             <?php echo $mynode->body['und'][0]['summary'];  ?>
            </td>
          </tr>
          <!-- Fin Contenu/Résumé -->
          <tr>
          ...
          <tr>
            <td width="360" height="32">
              <a href="<?php echo url(drupal_get_path_alias('node/'.$mynode->nid), array('absolute' => TRUE)); ?>" title="Lire la suite sur notre site" style="display: block;">
                <img border="0" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/btn_plus.gif" width="32" height="32" alt="Bouton lire la suite sur notre site" title="Lire la suite sur notre site" style="display: block;"/>
              </a>
            </td>
          </tr>
            ...
            <td width="250">
              <table width="250" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#879e33">
                ...
                <tr>
                  ...
                  ?>
                    <a href="<?php echo url(download_file_url($dl_agendas['fid']), array('absolute' => TRUE)); ?>" style="color: #FFFFFF;"><?php if($dl_agendas['description'] != ""){ echo $dl_agendas['description']."<br/>"; } ?></a>
                  <?php }  ?>
                  <?php
                  foreach($agenda->field_telechargements_agenda['und'] as $dl_agenda){
                  ?>
                    <a href="<?php echo url(download_file_url($dl_agenda['fid']), array('absolute' => TRUE)); ?>" style="color: #FFFFFF;"><?php if($dl_agenda['description']  != "") {echo $dl_agenda['description']."<br/>"; } ?></a>
                  <?php }  ?>
                  </td>
                  <td width="20"></td>
                </tr>
    ...
    <tr>
      ...
      <td width="630" colspan="4">
        ...
        <table width="630" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
          <tr>
            <?php foreach($agenda->field_visuels_agenda['und'] as $visuels_agenda){
            ...
            ?>
            <td style="text-align: left;vertical-align: middle;">
				<?php if($image_agenda->field_lien_fc_agenda['und'][0]['url']): ?><a href="<?php echo url($image_agenda->field_lien_fc_agenda['und'][0]['url'], array('absolute' => TRUE)); ?>" style="display: block;"><?php endif; ?>
					<?php print $thumb; ?>
    ...
    <tr>
      <td width="650" height="138">
        <a href="http://www.pfca34.org" title="Visitez notre site" target="_blank" style="display: block;">
          <img border="0" width="650" height="138" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/footer.gif" style="display: block;"/>
        </a>
      </td>
    </tr>
  </table>
    ...
    <tr>
      <td width="650" height="30">
        <a href="http://www.choosit.com" title="Choosit l'agence digitale" target="_blank" style="display: block;">
          <img border="0" width="650" height="30" src="<?php print $base_path; ?>/sites/all/themes/pfca/images/newsletter/choosit.gif" style="display: block;"/>
        </a>
      </td>
    </tr>
  </table>
