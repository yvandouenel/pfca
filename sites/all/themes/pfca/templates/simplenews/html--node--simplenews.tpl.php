...
<body marginwidth="0" marginheight="0" topmargin="0" leftmargin="0" style="color:#4b4b4b;line-height:20px;font-family:Arial, sans-serif;font-size:11px;background-color:#f5f5f5;margin-bottom:20px;margin-top:20px;margin-right:0px;margin-left:0px;-webkit-text-size-adjust:none;">
  <!--
<center>
    Si vous rencontrez des difficult&#233;s pour visualiser cette newsletter, consultez la <a href="#" title="Consultez la version en ligne" target="_blank" style="color:#879e33; text-decoration: underline;">version en ligne.</a><br/>
  </center>
-->	<?php
	global $user;
	if(in_array('administrator', array_values($user->roles)) || in_array('webmaster', array_values($user->roles))){
	?>
	<div style="text-align:center; width:100%;"><a href="/node/<?php print $node->nid; ?>/edit" style="text-decoration: none; color: #074965;font-family: "Arial";font-size: 11px;">Cliquez ici pour modifier la newsletter</a></div><br />
	<?php
	}
	?>
	<?php print $page; ?>
